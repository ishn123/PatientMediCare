...
export default function AdminDashboard() {
    ...
    const handleViewDetail = async (id) => {
        const data = submissions.filter((e) => e.id === id);
        router.push("/admin/viewDetails");
    }
    return (
        ...
        <>
                                ...
                                >
                                    <div className="p-6">
                                        ...
                                        <div className="flex justify-between pt-4 border-t">
                                            <a onClick={()=>handleViewDetail(submission.id)}
            ...
            {!isAdmin && (<div className="min-h-screen bg-gray-50 p-6 font-bold">No Access buddy 🥲</div>)}
        </>
