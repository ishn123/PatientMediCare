...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        try{
            checkAdmin().then(()=>{
                fetchData().then(r => setIsAdmin(true))
                }
            )
        }catch(error){
            setIsAdmin(false);
    ...
    useEffect(() => {
        console.log("admin changes",isAdmin)
    }, [isAdmin]);
    return (
        <>
                                        ...
                                        {expandedSubmission === submission.id && (
                                            ...
                                            >
                                                <div className="border-t border-gray-200 px-6 py-4">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="space-y-3">
                                                                ...
                                                                <div>
                                                                    <p className="text-xs text-gray-500">Date of
                                                                        Birth</p>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="space-y-3">
                                                                <div>
                                                                    <p className="text-xs text-gray-500">Medication
                                                                        Name</p>
                                                    ...
                                                    {/* Health Information */}
                                                    <div className="mt-6">
                                                        <h4 className="font-medium mb-3 text-blue-600">Health
                                                            Information</h4>
                                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                            <div>
                                                                <p className="text-xs text-gray-500">Medical
                                                                    Conditions</p>
                                                                <p>{submission.conditions}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-xs text-gray-500">Current
                                                                    Medications</p>
                                                    ...
                                                    <div className="mt-6">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div>
                                                                <p className="text-xs text-gray-500">Swallowing
                                                                    Difficulty</p>
                                                    ...
                                                    <div className="mt-6">
                                                        {submission.comments && (
                                                            <div className="mb-4">
                                                                <p className="text-xs text-gray-500">Patient
                                                                    Comments</p>
            ...
            </div>):(<div className="min-h-screen bg-gray-50 p-6 font-bold flex items-center justify-center">
